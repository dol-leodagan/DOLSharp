...
namespace DOL.GS.ClientPacket
{
    ...
    /// </summary>
    public class CryptKeyClientPacket_186 : CryptKeyClientPacket
    {
        public virtual byte KeyLength { get; set; }
        
        /// <summary>
        /// Create a new Instance of <see cref="CryptKeyClientPacket_186"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public CryptKeyClientPacket_186(GSPacketIn Packet)
        {
            ...
            if (RC4Enabled == 1)
            {
                KeyLength = (byte)Packet.ReadByte();
        ...
        protected CryptKeyClientPacket_186() { }
    }
}
