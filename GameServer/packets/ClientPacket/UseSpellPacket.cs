...
namespace DOL.GS.ClientPacket
{
    ...
    /// </summary>
    public class UseSpellPacket : AbstractClientPacket
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="UseSpellPacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public UseSpellPacket(GSPacketIn Packet)
        {
