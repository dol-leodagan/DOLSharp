...
{
    /// <summary>
    /// Client Packet sent when requesting to pick up an House Item.
    /// </summary>
    public class HousePlayerPickupItem : AbstractClientPacket, IClientPacketHouseOid
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="HousePlayerPickupItem"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public HousePlayerPickupItem(GSPacketIn Packet)
        {
        ...
        protected HousePlayerPickupItem() { }
    }
}
