...
{
    /// <summary>
    /// Client Packet sent when trying to enter or leave House.
    /// </summary>
    public class HouseEnterLeavePacket : AbstractClientPacket, IClientPacketHouseOid
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="HouseEnterLeavePacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public HouseEnterLeavePacket(GSPacketIn Packet)
        {
        ...
        protected HouseEnterLeavePacket() { }
    }
}
