...
{
    /// <summary>
    /// Client Packet sent when Looking for Open Group or Members
    /// </summary>
    public class FindGroupPacket : AbstractClientPacket
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="FindGroupPacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public FindGroupPacket(GSPacketIn Packet)
        {
