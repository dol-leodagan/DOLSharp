...
{
    /// <summary>
    /// Client Packet sent when player use a sloted item.
    /// </summary>
    public class UseSlotPacket : AbstractClientPacket
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="UseSlotPacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public UseSlotPacket(GSPacketIn Packet)
        {
