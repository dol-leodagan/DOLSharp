...
namespace DOL.GS.ClientPacket
{
    ...
    /// </summary>
    public class RegionListRequestPacket_174 : RegionListRequestPacket_172
    {
        public virtual byte ClassId { get; set; }
        public virtual byte Expantions { get; set; }
        
        /// <summary>
        /// Create a new Instance of <see cref="RegionListRequestPacket_174"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public RegionListRequestPacket_174(GSPacketIn Packet)
        {
        ...
        protected RegionListRequestPacket_174() { }
    }
}
