...
{
    /// <summary>
    /// Client Packet sent when Requesting an Item Appraise.
    /// </summary>
    public class AppraiseItemPacket : AbstractClientPacket, IClientPacketSessionId
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="AppraiseItemPacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public AppraiseItemPacket(GSPacketIn Packet)
        {
