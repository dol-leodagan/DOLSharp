...
{
    /// <summary>
    /// Client Packet sent when player sell an item.
    /// </summary>
    public class SellItemPacket : AbstractClientPacket, IClientPacketSessionId
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="SellItemPacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public SellItemPacket(GSPacketIn Packet)
        {
