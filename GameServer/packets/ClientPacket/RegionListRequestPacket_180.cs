...
namespace DOL.GS.ClientPacket
{
    ...
    /// </summary>
    public class RegionListRequestPacket_180 : RegionListRequestPacket_174
    {
        public virtual uint VideoVendorId1 { get; set; }
        public virtual uint VideoVendorId2 { get; set; }
        
        /// <summary>
        /// Create a new Instance of <see cref="RegionListRequestPacket_180"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public RegionListRequestPacket_180(GSPacketIn Packet)
        {
            ...
            if (Flag > 0)
            {
                ...
                ClassId = (byte)Packet.ReadByte();
                Expantions = (byte)Packet.ReadByte();
                VideoVendorId1 = Packet.ReadIntLowEndian();
                VideoVendorId2 = Packet.ReadIntLowEndian();
                Zero = (byte)Packet.ReadByte();
            }
        }
        
        protected RegionListRequestPacket_180() { }
    }
}
