...
namespace DOL.GS.ClientPacket
{
    ...
    /// </summary>
    public class CharacterCreatePacket_199 : CharacterCreatePacket
    {
        /// <summary>
        /// Create a new Instance of <see cref="CharacterCreatePacket_199"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public CharacterCreatePacket_199(GSPacketIn Packet)
        {
        ...
        protected CharacterCreatePacket_199() { }
    }
}
