...
{
    /// <summary>
    /// Client Packet sent when player set item market price.
    /// </summary>
    public class SetMarketPricePacket : AbstractClientPacket
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="SetMarketPricePacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public SetMarketPricePacket(GSPacketIn Packet)
        {
        ...
        protected SetMarketPricePacket() { }
    }
}
