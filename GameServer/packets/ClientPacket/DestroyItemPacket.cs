...
{
    /// <summary>
    /// Client Packet sent when requesting an item to be destroyed.
    /// </summary>
    public class DestroyItemPacket : AbstractClientPacket, IClientPacketSessionId
    {
        ...
        /// <summary>
        /// Create a new Instance of <see cref="DestroyItemPacket"/> using Packet.
        /// </summary>
        /// <param name="Packet">GameServer Packet to Parse.</param>
        public DestroyItemPacket(GSPacketIn Packet)
        {
